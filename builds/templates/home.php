    ...
    <div class="row">
        ...
        <div class="col-sm-9" style="float:right;">
            ...
            <div class="col-xs-12 col-sm-10 ">
                ...
                <img class="main-img" src="/micropics/builds/images/Microscope Photos/Bugs/Spiders/SmallRedSpiderCH4.jpg" width="100%">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <ul>
                ...
                <li><strong>Family Deinopidae, species Deinopis spinosa</strong> – the Net-casting Spider (aka Ogre-faced Spider); note that the four other eyes are not visible from the front.</li>
